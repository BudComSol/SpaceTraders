...
$LNG['page_doesnt_exist']					= 'Our sincere apologies but the page you are seeking to find does not exist!';
$LNG['bad_forum_url']				    	= 'The Forum link is incorrect!';
$LNG['admin_access_1']				    	= 'Players have been granted temporary administrative permissions.<br>';
$LNG['admin_access_link']				    = 'Disable this access';
$LNG['admin_access_2']				    	= ", immediately if it is no longer required.";
...
$LNG['bd_shipyard_required']				= 'You are required to build a Shipyard before this feature becomes available!';
$LNG['bd_building_shipyard']				= 'Cannot build ships until Shipyard upgrade has been completed and signed off!';
...
$LNG['tr_not_enought']						= "You don't have enough %s, consider buying a pack to assist efforts.";
...
$LNG['mg_overview']                         = 'Communications Center';
